...
export interface ApiBeforeAfterBeforeAfter extends Schema.CollectionType {
  ...
  attributes: {
    imagebefore: Attribute.Media
    imageafter: Attribute.Media
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
    publishedAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::before-after.before-after', 'oneToOne', 'admin::user'> & Attribute.Private
    updatedBy: Attribute.Relation<'api::before-after.before-after', 'oneToOne', 'admin::user'> & Attribute.Private
  }
}
...
export interface ApiDepartmentDepartment extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime
    publishedAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::department.department', 'oneToOne', 'admin::user'> & Attribute.Private
    updatedBy: Attribute.Relation<'api::department.department', 'oneToOne', 'admin::user'> & Attribute.Private
  }
}
...
export interface ApiDoctorDoctor extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime
    publishedAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::doctor.doctor', 'oneToOne', 'admin::user'> & Attribute.Private
    updatedBy: Attribute.Relation<'api::doctor.doctor', 'oneToOne', 'admin::user'> & Attribute.Private
  }
}
...
export interface ApiHospitalHospital extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required
    image: Attribute.Media & Attribute.Required
    departments: Attribute.Relation<'api::hospital.hospital', 'oneToMany', 'api::department.department'>
    locations: Attribute.Relation<'api::hospital.hospital', 'oneToMany', 'api::location.location'>
    ...
    updatedAt: Attribute.DateTime
    publishedAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::hospital.hospital', 'oneToOne', 'admin::user'> & Attribute.Private
    updatedBy: Attribute.Relation<'api::hospital.hospital', 'oneToOne', 'admin::user'> & Attribute.Private
  }
}
...
export interface ApiInquryInqury extends Schema.CollectionType {
  ...
  attributes: {
    ...
    treatment: Attribute.Enumeration<['hairTransplant', 'dentalCare', 'plasticSurgery']> & Attribute.Required
    note: Attribute.Text
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
    publishedAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::inqury.inqury', 'oneToOne', 'admin::user'> & Attribute.Private
    updatedBy: Attribute.Relation<'api::inqury.inqury', 'oneToOne', 'admin::user'> & Attribute.Private
  }
}
